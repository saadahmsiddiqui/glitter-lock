...
impl Pack for GlitterLock {
    ...
    fn unpack_from_slice(src: &[u8]) -> Result<Self, ProgramError> {
        ...
        Ok(GlitterLock {
            ...
            temp_account_key: Pubkey::new_from_array(*temp_account_key),
    ...
    fn pack_into_slice(&self, dst: &mut [u8]) {
        ...
        initializer_pubkey_dst.copy_from_slice(initializer_public_key.as_ref());
        temp_account_key_dst.copy_from_slice(temp_account_key.as_ref());
