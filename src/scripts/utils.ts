...
export const getBalance = async (connection: solanaWeb3.Connection, keypair: solanaWeb3.Keypair): Promise<number> => {
...
export const lamports = (amount: number) => new BigNumber(amount).times(new BigNumber(10).pow(9)).toNumber()
